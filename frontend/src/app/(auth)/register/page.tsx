    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-8">
      <div className="bg-slate-800 rounded-lg p-8 w-full max-w-md">
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full bg-slate-700 px-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-600"
        ...
        <p className="text-center text-slate-400 mt-6">
          ...
          <Link href="/login" className="text-red-600 hover:text-red-400 font-semibold">
            Sign in here
          </Link>
        </p>
      </div>
